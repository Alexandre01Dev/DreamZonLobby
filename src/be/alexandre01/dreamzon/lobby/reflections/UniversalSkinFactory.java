...
public class UniversalSkinFactory extends SkinFactory {
    ...
    private Class<?> PlayOutEntityHeadRotation;
    private Class<?> PlayOutEntityLook;
    ...
    public UniversalSkinFactory() {
        try {
            ...
            PlayOutEntityHeadRotation = ReflectionUtil.getNMSClass("PacketPlayOutEntityHeadRotation");
            PlayOutEntityLook = ReflectionUtil.getNMSClass("PacketPlayOutEntity$PacketPlayOutEntityLook");
    ...
    public void updateSkin(Player player) {
        Bukkit.getScheduler().scheduleSyncDelayedTask(Main.getInstance(), () -> {
            ...
            try {
                ...
                try {
                    // 1.9+
                    headrotation = ReflectionUtil.invokeConstructor(PlayOutEntityHeadRotation,
                            new Class<?>[]{Entity.class, byte.class},
                            ((CraftPlayer) player).getHandle(),(byte) ((l.getYaw()%360.)*256/360));
               ...
               Object look;
                       ...
                       look = ReflectionUtil.invokeConstructor(PlayOutEntityLook, new Class<?>[]{int.class,byte.class,byte.class,boolean.class},
                        player.getEntityId(),getFixRotation(l.getYaw()),getFixRotation(l.getPitch()),true);
                ...
                if (MAINHAND == null) {
                    ...
                    hand = ReflectionUtil.invokeConstructor(PlayOutEntityEquipment,
                            ...
                            ReflectionUtil.invokeMethod(CraftItemStack, null, "asNMSCopy",
                                    new Class<?>[]{org.bukkit.inventory.ItemStack.class}, new Object[]{player.getItemInHand()}));
                    ...
                    boots = ReflectionUtil.invokeConstructor(PlayOutEntityEquipment,
                            ...
                            ReflectionUtil.invokeMethod(CraftItemStack, null, "asNMSCopy",
                                    new Class<?>[]{org.bukkit.inventory.ItemStack.class}, new Object[]{player.getInventory().getBoots()}));
                }
                // If 1.9+
                ...
                for (Player pOnline : Bukkit.getOnlinePlayers()) {
                    ...
                    if (pOnline.equals(player)) {
                        ...
                        sendPacket(playerCon, headrotation);
                        sendPacket(playerCon, look);
